...
const Profile = () => {
  ...
  return (
    ...
    <div className="d-flex justify-content-evenly">
      ...
      <button  onClick={() => setOpen(!open)} className='btn fw-bolder text-warning'><i className='fa-solid fa-chevron-down'></i></button>
    </div>
    <Collapse in={open}>
        <div className='row align-items-center justify-content-center shadow rounded p-3' id="example-collapse-text">
          ...
          <div className="mb-2">
            <input onChange={e=>setUserData({...userData,github:e.target.value})} value={userData.github} placeholder='git-hub url' type="text" className='form-control' />
          </div>
          <div className="mb-2">
